...
--sungjuk테이블 입력 데이터
 ※ 참조 : D:\java202307\database\section0818\06.성적테이블.sql
...
--문2) 주소별 국어점수에 대해서 집계하고, 주소순으로 정렬해서 조회하시오
...
select *
from sungjuk order by aver, addr;
